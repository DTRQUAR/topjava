...
public class SpringMain {
    public static void main(String[] args) {
        ...
        try (ConfigurableApplicationContext appCtx = new ClassPathXmlApplicationContext("spring/spring-app.xml" , "classpath:spring/spring-db.xml")) {
            DbPopulator db = appCtx.getBean(DbPopulator.class);
            db.execute();
...
//            filteredMealsWithExceeded.forEach(System.out::println);
            ...
            JdbcUserMealRepositoryImpl mealRepository = appCtx.getBean(JdbcUserMealRepositoryImpl.class);
            //System.out.psrintln(mealRepository.delete(100000, 100000));
            System.out.println(mealRepository.get(100003, 100000));
