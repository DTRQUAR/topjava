package ru.javawebinar.topjava.JDBC_Tests;
...
import ru.javawebinar.topjava.AbstractTestClass;
...
public class JDBC_UserMealServiceTest extends AbstractTestClass{
        private static final LoggerWrapper LOG = LoggerWrapper.get(JDBC_UserMealServiceTest.class);
