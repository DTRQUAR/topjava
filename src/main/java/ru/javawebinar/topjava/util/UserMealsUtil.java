...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExceed> filteredMeals = getFilteredMealsWithExceeded(storeMeals, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);

    public static Map<Integer, UserMealWithExceed> mapUserMealWithExceed = new HashMap<>();
    static {
        for (int i = 0; i < filteredMeals.size(); i++){
            mapUserMealWithExceed.put(i, filteredMeals.get(i));
        }
    }
